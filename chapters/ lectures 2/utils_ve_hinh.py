...
def ve_mo_hinh_con_lac():
    ...
    ax.plot([0, bob_x], [0, bob_y], color='black', linewidth=2.5) 
...
def ve_do_thi_overdamped():
    ...
    ax.plot([-2*np.pi, 0, 2*np.pi], [0, 0, 0], 'o', color='black', markersize=10, zorder=10)
    ax.plot([-np.pi, np.pi], [0, 0], 'o', mfc='white', mec='black', mew=2, markersize=10, zorder=10)
